...
```html
<script src="https://nbed64.oss-cn-hongkong.aliyuncs.com/nbed64.es5.all.js">/*完整版----研究環境時使用*/</script>
<script src="https://nbed64.oss-cn-hongkong.aliyuncs.com/nbed64.es5.min.js">/*迷你版----生產環境時使用*/</script>
```

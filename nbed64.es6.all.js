 ...
 * @return string 加密结果
 */
export const nbed64BinaryEncrypt = (byteArr, key, isRFC4648 = true) => {
 ...
 */
export const nbed64BinaryDecrypt = (base64str, key) => {
 ...
 * @return string 加密结果
 */
export const nbed64BinaryEncryptEx = (byteArr, key, maskNumber = 32) => {
 ...
 * @return ByteArray 解密结果
 */
export const nbed64BinaryDecryptEx = (base64str, key) => {
 ...
 * @return string 加密结果
 */
export const nbed64StringEncrypt = (str, key, isUtf8 = true, isRFC4648 = true) => {
 ...
 */
export const nbed64StringDecrypt = (base64str, key, isUtf8 = true) => {
 ...
 * @return string 加密结果
 */
export const nbed64StringEncryptEx = (str, key, isUtf8 = true, maskNumber = 32) => {
	const byteArr = isUtf8 ? _utf16ToUtf8ToByteArray(str, 4) : _strUtf16ToByteArray(str, 4);
 ...
 * @return string 解密结果（UTF-16编码格式）。注意：为方便使用，解密结果会自动转换成当前程序语言的默认编码，以便开箱即用，省略二次编码。JS默认编码：UTF-16
 */
export const nbed64StringDecryptEx = (base64str, key, isUtf8 = true) => {
 ...
 * @return string 编码结果
 */
export const nbed64BinaryEncode = (byteArr, isRFC4648 = true) => {
	const mapArr = _mapToByteArray(isRFC4648);
	const bl = byteArr.length;
	const rem = bl % 3;
	const num = bl % 3 === 0 ? parseInt(bl / 3) : parseInt(bl / 3) + 1;
 ...
 */
export const nbed64BinaryDecode = (base64str) => {
	const bl = base64str.length;
	const num = bl % 4;
	const rem = num === 0 ? 0 : 4 - num;
	const loop = rem === 0 ? parseInt(bl / 4) : parseInt(bl / 4) + 1;
 ...
 * @return string 编码结果
 */
export const nbed64StringEncode = (str, isUtf8 = true, isRFC4648 = true) => {
	const byteArr = isUtf8 ? _utf16ToUtf8ToByteArray(str, 4) : _strUtf16ToByteArray(str, 4);
 ...
 */
export const nbed64StringDecode = (base64str, isUtf8 = true) => {
 ...
 */
const _utf16ToUtf8ToByteArray = (str, empty = 0) => {
	let k = 0;
 ...
 * @return String 转换结果
 */
const _byteArrayToUtf8ToUtf16 = (byteArr) => {
	let i = 0,
		a = 0,
		b = 0,
		c = 0,
 ...
 * @return ByteArray 转换结果
 */
const _strUtf16ToByteArray = (str, empty = 0) => {
	let i = 0;
	let k = 0;
	let strLen = str.length;
 ...
 * @return String 转换结果
 */
const _byteArrayToUtf16 = (byteArr) => {
	let i = 0;
	let short = 0;
	let utf16Str = '';
	let strLen = byteArr.length;
 ...
 * @return ByteArray 转换结果
 */
const _base64strToByteArray = (base64str) => {
 ...
 * @return ByteArray 转换结果
 */
const _maskToByteArray = (maskNumber) => {
 ...
 * @return ByteArray 转换结果
 */
const _shortToByteArray = (twoByte) => {
 ...
 */
const _byteArrayGetShort = (byteArr) => {
 ...
 * @return ByteArray 转换结果
 */
const _mapToByteArray = (rfc4648 = false) => {
	let map = '';
	if (rfc4648) {
